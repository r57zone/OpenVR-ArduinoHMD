...
Название | Описание
------------ | -------------
**Numpad 5**, **CTRL + ALT + R** | Центрирование изображения по центру.
**Page Up, Page Down** | Подняться или опуститься.
**Numpad 8, Numpad 2, Numpad 4, Numpad 6** | Перемещение вперед, назад, влево, вправо. 
**Numpad 1, Numpad 3** | Изменить Yaw (Рысканье).
**Numpad 7, Numpad 9** | Изменить Roll (Крен).
